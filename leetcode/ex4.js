// write a findIndex(numbers, num)function that finds the index of num in the given numbers
//  array in O( log(n) ).

// Use the following sorted array to determine what the index of the number 2630 is - 
// you should find it to be 86
...
console.log(findIndex(numbers, 2472));
